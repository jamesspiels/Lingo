...
const LeaderboardPage = async () => {
    ...
    const userSubsctriptionData = getUserSubscription();
    const leaderboardData = getTopTenUsers()

    const [userProgress, userSubscription, leaderboard] = await Promise.all([userProgressData, userSubsctriptionData, leaderboardData])
